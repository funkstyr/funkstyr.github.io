...
description: "but that sounds complicated"
publishDate: "25 Feb 2024"  
tags: ["monorepo", "tubrorepo", "typescript"]
---
...
where we had a multi-tenant React application for over 800 appliance and furniture
stores across the country. Why was I interested in monorepos at this time?

<br/>

Well, our application had some main areas: csm, catalog, product, the cart + checkout, and
...
monoreps were under quite the duress.
...
I have very strong nuero-divergent tendencies which means I binge a new app idea for a couple days, weeks, months
...
I envision myself working in this repo for awhile, trying to get the first iteration of <a href="https://hub.omnibytes.io" target="_blank" rel="noopener noreferrer">Pi-Hub</a>
